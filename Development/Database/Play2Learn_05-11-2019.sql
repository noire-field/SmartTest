...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2019 at 01:48 PM
...
(346, 41, 0, 'Number, Interger, char', NULL, 0),
(347, 41, 0, 'Number, String, Boolean, Null', NULL, 1),
(348, 41, 0, 'Number, String, Boolean', NULL, 0),
(349, 41, 0, 'Tất cả các loại trên', NULL, 0),
(350, 45, 0, 'Không', NULL, 0),
(351, 45, 0, 'Có', NULL, 1),
(352, 45, 0, 'Chắc vậy', NULL, 0),
(353, 45, 0, 'Ai biết', NULL, 0),
(354, 42, 0, '<!-- Đây là một comment trên nhiều dòng -->', NULL, 0),
(355, 42, 0, '// Đây là một comment trên nhiều dòng // ', NULL, 0),
(356, 42, 0, '{{ Đây là một comment trên nhiều dòng }}', NULL, 0),
(357, 42, 0, '/* Đây là một comment trên nhiều dòng */ ', NULL, 1);
...
(7, '97775', 'You don\'t know JS', 12, 15, '2019-11-01 20:39:09', '2019-11-05 15:59:18', '2019-11-05 15:58:11', 0, 5);
...
(4, 7, '54654', 1, 7, 100, 1, '2019-11-04 10:35:22');
...
(41, 12, 'JavaScript có các kiểu biến dạng nào?', NULL, 5),
...
--
ALTER TABLE `answers`
  MODIFY `AnsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=358;
